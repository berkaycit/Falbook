...
/*
    ...
    public void handler(){
        ...
        fbFalGonder.setCompatElevation(0f);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.menuAnasafaButon:
                        Toast.makeText(ToolbarActivity.this, "Anasayfa buton", Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.menuGelenfalButon:
                        Toast.makeText(ToolbarActivity.this, "Gelenfal buton", Toast.LENGTH_LONG).show();
                        break;
                }
                return true;
            }
